...
public class AddRoles implements ApplicationListener<ContextRefreshedEvent> {
  ...
  @Autowired
  public AddRoles(RoleJpaRepository repository, UserJpaRepository userJpaRepository, ActivityJpaRepository activityJpaRepository) {
  ...
  public void onApplicationEvent(ContextRefreshedEvent event) {
    ...
    if (roles.isEmpty()) {
      ...
      runSeeds(roles_list.get(0));
    }

  }

  private void runSeeds(RoleModel role) {
